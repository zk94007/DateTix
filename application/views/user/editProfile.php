						...
						<div id="basics"
							...
							<div class="step-form-Part">
								...
								<div id="district_block">
									...
									<div class="sfp-1-main">
										<div class="sfp-1-Left"><?php echo translate_phrase('Neighborhood') ?>:<span>*</span></div>
										<div class="sfp-1-Right">
										<?php 
								...
								<div class="sfp-1-main">
									<div class="sfp-1-Left"><?php echo translate_phrase('My height is')?>:</div>
									<div class="sfp-1-Right">
									<?php
							...
							<div class="step-form-Part">
								...
								<div id="add_schools" class="fl" <?php echo $schol_show;?>>
									...
									<div class="sfp-1-main">
										...
										<div class="sfp-1-Right">
											<input id="degree_name" class="DegreeInput Degree-input"
...
<!--									<div class="sfp-1-main">
										<div class="sfp-1-Left"><?php echo translate_phrase('Years attended') ?>:</div>
										<div class="sfp-1-Right">
										<?php
...
/*--------------------------------CPOIED from step1---------------------------------*/
	function add_school(from_validate){
       ...
       if(school_domain!='undefined')
           ...
           var domain        = "";
		//&& (yr_start !=""  && yr_start != 0) && (yr_end != "" && yr_end != 0) && yearsAttendedRangeIsCorrect === true
