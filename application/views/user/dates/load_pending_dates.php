...
<!-- Start USER DIV  -->
<div id="intro_<?php echo $intro['user_intro_id']?>" class="itemBox">
	<div class="userBox">
		...
		<div class="userTop">
			...
			<?php if (isset($intro['primary_photo'])&& $intro['primary_photo']): ?>
				...
				<div class="profileBtn">
					<a href="<?php echo $intro['view_profile_link']?>"><span
							class="appr-cen">
			...
			<div class="userBoxRight">
				...
				<?php if(isset($intro['common_likes']) && $intro['common_likes']):?>
					...
					<?php if(isset($intro['fb_mutual_friend']) && $intro['fb_mutual_friend']):?>
						<a
							href="<?php echo base_url().url_city_name().'/mutual-friends.html?return_to=my-date.html&tab=pending&fb_id='.$intro['fb_id'];?>"><?php echo $intro['fb_mutual_friend'];?>
						</a>
						<?php else:?>
