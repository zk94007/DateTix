...
function check_terms(){
	...
	{
		jQuery('#heardAboutUsError').text('<?php echo translate_phrase("Please tell us how you heard about DateTix")?>');
							...
							<div class="edu-main">
								...
								<?php if(isset($mobile_phone_is_verified) && $mobile_phone_is_verified == 1):?>
									...
									<div class="sfp-1-main" id="main_phoneDiv">
										...
										<?php if(isset($mobile_phone_verification_code_sent) && $mobile_phone_verification_code_sent == 1):?>
											<label><?php echo '(+'.$country_code.') '.$mobile_phone_number;?>
											</label>
											<?php else:?>
											<div class="centimeter pad-L-none">
												(
											...
											<input type="text" class="PhoneNum-input"
												...
												value="<?php echo isset($form_data['mobile_phone_number'])?$form_data['mobile_phone_number']:''?>"
												id="mobile_phone_number" autofocus="autofocus" />
											<div class="sch-logoR">
									...
									<div class="Down-Evua">
										<h2> <?php echo translate_phrase('How did you hear about us?')?><span class="Redstar">*</span></h2>
										<div class="f-decrMAIN">
											...
											<div class="captcha-img">
												...
												<?php echo translate_phrase('By clicking on the Submit Application button below, you are indicating that you have read, understood, and agree to our ')?>
													<a href="javascript:;">Terms of Use</a> and <a
