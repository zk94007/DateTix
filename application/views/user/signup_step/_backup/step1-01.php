			...
			<div id="basics" class="Apply-Step1-a-main">
					<div class="Thanks-verify">
						<span class="Th-highlight"> <?php if (isset($is_return_apply) && !$is_return_apply): echo translate_phrase($this->session->userdata('succ_email_verify')); endif?>
							...
							<?php echo translate_phrase("To RSVP for the event, please tell us the basics about yourself so we can help you find the best people to meet at the event!"); ?>
							<?php else:?>
							<?php echo translate_phrase("Please tell us more about yourself so that we can find great matches for you.")?>
							<?php endif;?>							
						</span>
					</div>
