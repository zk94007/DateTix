			...
			<div id="photos">
					<div class="Apply-Step1-a-main">
						...
						<div class="Thanks-verify">
							<span class="Th-highlight"><?php echo translate_phrase("Please tell us a bit more about yourself so that we can help you find even better matches.")?>
							</span>
						</div>
						<div class="step-form-Main">
							...
							<?php endif; ?>
								...
								<div class="sfp-1-main">
									<div class="sfp-1-Left"><?php echo translate_phrase('My relationship status is')?>:</div>
									<div class="sfp-1-Right">
									<?php 
									$selected_relationship_status  = $fb_user_data['relationship_status']?$fb_user_data['relationship_status']:set_value('relationship_status');
									
									foreach($relationship_status as $row):?>
										<a href="javascript:;" class="rdo_div"
											key="<?php echo $row['relationship_status_id'];?>"><span class="<?php echo $selected_relationship_status==$row['relationship_status_id'] ?"appr-cen":"disable-butn";?>"><?php echo translate_phrase(ucfirst($row['description']));?>
										</span> </a>
										<?php endforeach; ?>
										<input type="hidden" name="relationship_status"
											value="<?php echo $selected_relationship_status?>">
									</div>
								</div>
								<div class="sfp-1-main">
									...
									<div class="sfp-1-Right">
										...
										foreach($religious_belief as $belief_id=>$row):?>
										<a href="javascript:;" class="rdo_div" key="<?php echo $belief_id;?>"> <span class="<?php echo $religious_belief_id == $belief_id ?"appr-cen":"disable-butn";?>"><?php echo $row;?></span></a>
										<?php endforeach; ?>
										<input type="hidden" id="religiousBeliefId" name="religiousBeliefId" value="<?php echo $religious_belief_id;?>">
										<label id="religiousBeliefError" class="input-hint error" error_txt="<?php echo translate_phrase("Please specify your religious beliefs") ?>"></label>
									</div>
								</div>
