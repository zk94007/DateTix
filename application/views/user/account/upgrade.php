				...
				<div class="step-form-Main Mar-top-none Top-radius-none">
					<div class="step-form-Part">
						...
						<?php echo translate_phrase('Upgrade your account to enjoy')?>
							<span><?php echo translate_phrase('better and more introductions, discounted date tickets, and other exclusive benefits, resulting in endless romantic possibilities.')?></span>
						</div>
						<!-- Photo Section Added -->
						<?php if($user_photos):?>
