...
<!--								<h2>
								...
								<div class="sortby">
									<div class="mobileRow">
										<h2>
											<span class="Red-color">*</span>
											<?php echo translate_phrase('How would you prefer to be contacted by '.get_assets('name','DateTix').' when we find high quality matches for you')?>
											?
										</h2>
...
<!--									<div class="mobileRow">
										<h2>
										<?php echo translate_phrase('How selective should '.get_assets('name','DateTix').' be in introducing you to potential matches?')?>
										</h2>
						...
						<div class="step-form-Main Mar-top-none Top-radius-none"
							...
							<div class="step-form-Part">
								<h2><?php echo translate_phrase('What profile information could we show to your date matches?')?></h2>
								<div class="f-decrMAIN">
									<div class="f-decr">
							...
							<div class="step-form-Part sortby">
								...
								<ul class="applications cms-list comn-top-mar"">
									...
									<li class="list">
										...
										<a href="<?php echo base_url('user/user_info/'.$this -> utility -> encode($user['requested_by_user_id']).'/'.$this -> utility -> encode($user_data['user_id']).'/'.$this -> utility -> encode($user_data['password']));?>" class="blue-colr"> <?php echo $user['first_name'].' '.$user['last_name']?></a>
										<?php 
