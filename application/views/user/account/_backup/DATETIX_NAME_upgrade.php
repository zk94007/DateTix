						...
						<div class="edu-main" id="option_1">
							...
							<div class="accountTxt">-->
								<div class="accountTxtRight">
									<ul>
										<li><?php echo translate_phrase('Eliminates need for date tickets to suggest or accept dates with any of your matches')?></span>
										</li>
										<li><span><?php echo translate_phrase('Go on as many dates as you like at no extra cost')?>
										</span> <?php echo translate_phrase('and')?></span> <span><?php echo translate_phrase('enjoy far higher response rates')?>
										</span> <?php echo translate_phrase('by not requiring your matches to pay for date tickets to go on dates with you')?>
										</li>
									</ul>
								</div>
							</div>
...
default:
	...
	break;
					...
					<div class="edu-main">
						...
						<p>
						<?php echo translate_phrase('In order to ensure uninterrupted service, your DateTix subscription will be automatically extended before expiration, for successive renewal periods of the same duration as the subscription term originally selected at the then-current non-promotional subscription rate.')?>
						</p>
						<p>
