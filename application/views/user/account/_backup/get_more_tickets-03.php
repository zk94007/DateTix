					        ...
					        <div class="getBox">
					            	<div class="edu-main">
					                	...
					                	<div class="div-row mar-top2">
					                		<h2><span class="green-color">+300</span> <?php echo translate_phrase('free date tickets for liking our Facebook page')?></h2>
						...
						<div class="getBox">
							<div
								...
								<div class="discountTxt">
									<?php if($user_age <= 23 ):?>																
									<?php echo translate_phrase('You are eligible for a 30% student discount')?>!
									<?php else:?>
									<?php echo translate_phrase('You are eligible for a 30% discount because you are a DateTix Premium member')?>!
									<?php endif;?>
								</div>
								<div class="Ed-rM-but">
