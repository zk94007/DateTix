		...
		<div class="Apply-Step1-a-main">
			<div class="Edit-pge-Main">
				<div class="Edit-p-top1">
					<h1>
					<?php echo translate_phrase('Get Date Tickets')?>
					</h1>
				</div>
			</div>
			<div class="emp-B-tabing-prt">
				...
				<div class="step-form-Main Mar-top-none Top-radius-none">
					<div class="step-form-Part">
						...
						<?php echo translate_phrase('Want to go on dates with the most attractive singles from our database? Purchase a date ticket package to ')?>
							<span><?php echo translate_phrase('have our professional human matchmakers search our entire database to find the best matches for you, and then reach out to them on your behalf to arrange dates for you!')?></span>
							<?php echo translate_phrase('Each package includes a ')?><span><?php echo translate_phrase('free consultation')?></span>
							<?php echo translate_phrase('so that we better understand you and what you are looking for, and then present your profile in the most attractive way to your matches.')?></span>
						</div>
						...
						<div class="getBox">
							<div
								...
								<div class="discountTxt">
									...
									<?php else:?>
									<?php echo translate_phrase('You are eligible for an additional 30% because you have the Discounted Date Tickets account upgrade')?>!
									<?php endif;?>
								</div>
								<div class="Ed-rM-but">
