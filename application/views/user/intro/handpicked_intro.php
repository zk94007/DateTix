...
<?php if(isset($intros_data['handpicked_data']) && $intros_data['handpicked_data']):?>
<?php foreach ($intros_data['handpicked_data'] as $intro):?>
		...
		<div class="userTop">			
			<div class="userBoxLeft">
				...
				<div class="profileBtn">
					<a href="<?php echo $intro['view_profile_link'].'?redirect_intro_id='.$intro['user_intro_id'] ?>"><span class="appr-cen">
					<?php if($intro['gender_id'] == '1'):?>
						<?php echo translate_phrase('Chat with Him')?>
					<?php else:?>
						<?php echo translate_phrase('Chat with Her')?>
					<?php endif;?>						
					</span></a>
				</div>
			</div>					
