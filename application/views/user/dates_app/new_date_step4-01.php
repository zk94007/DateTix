								...
								<div class="f-decrMAIN">
									<div class="f-decr customSelectTag">																														
										<div class="scemdowndomain menu-Rightmar">
                                                                                        <?php echo form_dt_dropdown('country',$country,$user_data['current_city_id'],'id="current_country" class="dropdown-dt scemdowndomain menu-Rightmar" ', translate_phrase('Select country'), "hiddenfield");?>	
								...
								<div class="f-decrMAIN">
									<div class="f-decr customSelectTag">
											<?php foreach($neighbourhood_list as $key=>$row){?>
                                                                                                <ul>
                                                                                                    <li>
                                                                                                        <?php if($row['neighborhood_id']==$user_data['current_district_id']):?>
                                                                                                        
                                                                                                            <a id="<?php echo $row['neighborhood_id']; ?>" class="appr-cen" href="javascript:;" >
