				...
				<div class="emp-B-tabing-M-short" id="events_tabs">
					...
					<div class="step-form-Part">
						...
						<?php if($event_info['max_prepaid_tickets'] > 0):?>
							...
							<?php else:?>
							<div class="style01 comn-top-mar">
								<b><span class="DarkGreen-color fb_plugin_text" lang="<?php echo translate_phrase("Take HKD30 off instantly to all events by liking our Facebook page now")?>!">
									<?php echo translate_phrase("HKD30 discount has been applied to your ticket price because you liked our Facebook page")?>!</span></b>
							</div>
							<?php endif;?>
						...
						<?php if($event_info['max_prepaid_tickets'] > SMALL_EVENT_USER_LIMIT):?>
							<?php if(!$signup_discount):?>
								<?php  if($event_info['price_online'] - $event_info['price_online_discounted'] <= 0):?>
