				...
				<div class="emp-B-tabing-M-short" id="events_tabs">
					...
					<div class="step-form-Part">
						...
						<?php else:?>
							...
							<?php else:?>
							<div class="style01 comn-top-mar">
								<b><span class="DarkGreen-color fb_plugin_text" lang="<?php echo translate_phrase("Get a free 3 month premium membership to DateTix (valued at HK$888) by liking our Facebook page now")?>!"><?php echo translate_phrase("Email info@datetix.com with your name and email address to receive your free 3 month premium membership")?>!</span></b>
							</div>
							<?php endif;?>
						<?php endif;?>															      	
												...
												<div class="package">
													...
													<div class="guarantee">
														...
														<!--<?php echo translate_phrase('One easy ')?>
															...
															<?php if($package['save_amount']) echo '('.translate_phrase('Take ').$package['currency'].number_format($package['save_amount']).translate_phrase(' off non-member price').'!)';?>
														</p>
													</div>
												</div> 
										<?php if(count($ticket_packages) > 1):?>																				
									...
									<form id="payment_form"
										...
										<?php if($event_info['max_prepaid_tickets'] > SMALL_EVENT_USER_LIMIT):?>
											...
											<?php else:?>
												<?php if($event_info['event_id'] != 11):?>
													<?php if($ad_id != 999):?>
													<div class="style01 comn-top-mar"><span class="DarkGreen-color"><b><?php echo $package['currency'].number_format($package['save_amount']) . translate_phrase(" member discount has been applied to your ticket price because you are a DateTix member")?>!</b></span></div>																				
													<?php else:?>
													<div class="style01 comn-top-mar"><span class="DarkGreen-color"><b><?php echo translate_phrase("67% member discount has been applied to your ticket price because you are a DateTix member")?>!</b></span></div>
													<?php endif;?>																														
												<?php else:?>
													<div class="style01 comn-top-mar"><span class="DarkGreen-color"><b><?php echo translate_phrase("15% member discount has been applied to your ticket price because you are a DateTix member")?>!</b></span></div>
												<?php endif;?>																														
											<?php endif;?>																														
										<?php endif;?>																														
