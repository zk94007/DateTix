...
{
	<?php if($user_order):?>
		$("#pageMsg").text('<?php echo translate_phrase('You have already purchased a discounted member ticket for this event. If you want to purchase tickets for your friends, please ask them to sign up as DateTix members to purchase their own discounted member tickets online.')?>');
		goToScroll('pageMsg');
	<?php else:?>
			...
			<div class="emp-B-tabing-prt">
				<div class="emp-B-tabing-M-short" id="events_tabs">
					...
					<div class="step-form-Part">
						...
						<?php if(!$fb_like_discount && $event_info['max_prepaid_tickets'] > 0):?>
							<div class="style01 comn-top-mar">
							<b><span class="Red-color fb_plugin_text" lang="<?php echo translate_phrase("A HK$30 discount has been applied to your ticket price because you liked our Facebook page")?>!"><a href="http://www.facebook.com/datetix" target="_NEW"><?php echo translate_phrase("Take HK$30 off instantly")?></a><?php echo translate_phrase(" to all events by liking our Facebook page now")?>!</span></b>
							</div>
						...
						<div class="det-center-inner3">
							...
							<?php else:?>
								...
								<?php elseif ($event_info['max_prepaid_tickets'] == 0):?>
										<div class="order-btn"><a href="<?php echo base_url().url_city_name().'/event.html'.$form_para.'&freeRSVP'; ?>"> <?php echo translate_phrase('RSVP Now')?> &nbsp; <img src="<?php echo base_url()?>assets/images/c-arw.png" alt="" /></a></div>
								<?php endif;?>
							<?php endif;?>							
						</div>
					</div>
						...
						<div class="getBox" align="left">
							<?php if($ad_id == 4):?>
							<img style="max-height:98%; max-width:100%;" src="http://www.datetix.com/assets/images/events/9/9meetup.png" />
							<?php elseif($ad_id == 16):?>
							<img style="max-height:98%; max-width:100%;" src="http://www.datetix.com/assets/images/events/9/9chi_simp.png" />
							<?php elseif($ad_id == 21):?>
							<img style="max-height:98%; max-width:100%;" src="http://www.datetix.com/assets/images/events/9/9chi_simp.png" />
							<?php else:?>
						...
						<!--<div class="getBox">							
							...
							<ul class="cms-list userTop p-style">
								...
								<?php else:?>
								<li>1. <a href="http://www.datetix.hk/join"><?php echo translate_phrase("Apply for a free DateTix account")?></a><?php echo translate_phrase(" or ")?><a href="<?php echo base_url().url_city_name();?>/signin.html"><?php echo translate_phrase("sign in to your DateTix account")?></a></li>
								<?php endif;?>								
						...
						<div class="getBox">
							<?php if($total_rsvped >= 20) :?>
								<div class="selectDateHed"><span class="DarkGreen-color"><?php echo $total_rsvped.translate_phrase(" attendees have already RSVPed"); ?></span>, <?php echo translate_phrase('including people from the following companies and schools');?>:</div>
												...
												<div class="package">
													...
													<div class="guarantee">
														...
														<!--<?php echo translate_phrase('One easy ')?>
															...
															<?php if($package['save_amount']) echo '('.translate_phrase('Take ').$package['currency'].number_format($package['save_amount']).translate_phrase(' off walk-in price').'!)';?>
														</p>
													</div>
												</div> 
										<?php if(count($ticket_packages) > 1):?>																				
								...
								<div class="paymentArea">
									...
									<form id="payment_form"
										...
										<?php if($event_info['max_prepaid_tickets'] > 0):?>
											...
											<?php else:?>
											<div class="style01 comn-top-mar">
												<b><span class="DarkGreen-color fb_plugin_text" lang="<?php echo translate_phrase("Take HK$30 off instantly to all events by liking our Facebook page now")?>!"><?php echo translate_phrase("A HK$30 discount has been applied to your ticket price because you liked our Facebook page")?>!</span></b>
											</div>
											<?php endif;?>
										<?php endif;?>
										...
										<?php if($event_info['max_prepaid_tickets'] > SMALL_EVENT_USER_LIMIT):?>
											...
											<?php else:?>
												<?php if($event_info['event_id'] != 11):?>
													<?php if($ad_id != 999):?>
													<div class="style01 comn-top-mar"><span class="DarkGreen-color"><b><?php echo translate_phrase("A HK$140 member discount has been applied to your ticket price because you are a DateTix member")?>!</b></span></div>																				
													<?php else:?>
													<div class="style01 comn-top-mar"><span class="DarkGreen-color"><b><?php echo translate_phrase("A 67% member discount has been applied to your ticket price because you are a DateTix member")?>!</b></span></div>
													<?php endif;?>																														
												<?php else:?>
													<div class="style01 comn-top-mar"><span class="DarkGreen-color"><b><?php echo translate_phrase("A 15% member discount has been applied to your ticket price because you are a DateTix member")?>!</b></span></div>
												<?php endif;?>																														
											<?php endif;?>																														
										<?php endif;?>																														
