				...
				<div class="emp-B-tabing-M-short" id="events_tabs">
					...
					<div class="step-form-Part">
			        	<div class="userBox-wrap">
				                <div class="userTop">
							<span class="fl">
							<?php if($ad_id == 16 || $ad_id == 10 || $ad_id == 6):?>
							<div class="selectDateHed martop-edit"><?php echo translate_phrase("Buy Tickets for ").$event_info['event_name'];?></div>
							<?php elseif($ad_id == 4 || $ad_id == 7 || $ad_id == 9 || $ad_id == 13 || $ad_id == 14 || $ad_id == 15 || $ad_id == 16 || $ad_id == 17 || $ad_id == 18 || $ad_id == 19 || $ad_id == 20):?>
							<div class="selectDateHed martop-edit"><?php echo translate_phrase("Buy Tickets for Professional Networking Night");?></div>
							<?php else:?>
							<div class="selectDateHed martop-edit"><?php echo translate_phrase("Buy Tickets for ").$event_info['event_name'];?></div>
							<?php endif;?>														
						...
						<div class="det-center-inner3">
							...
							<?php else:?>
								<?php if($this->user_id || $event_info['max_prepaid_tickets'] > SMALL_EVENT_USER_LIMIT):?>
						...
						<div class="getBox" align="left">
							<?php if($ad_id == 16):?>
							<img style="max-height:98%; max-width:100%;" src="http://www.datetix.com/assets/images/events/4/4aigangpiao.png" />
							<?php elseif($ad_id == 10):?>
							<img style="max-height:98%; max-width:100%;" src="http://www.datetix.com/assets/images/events/4/4tgif (CN).png" />
							<?php elseif($ad_id == 4 || $ad_id == 6 || $ad_id == 7 || $ad_id == 9 || $ad_id == 13 || $ad_id == 14 || $ad_id == 15 || $ad_id == 16 || $ad_id == 17 || $ad_id == 18 || $ad_id == 19 || $ad_id == 20):?>
							<img style="max-height:98%; max-width:100%;" src="http://www.datetix.com/assets/images/events/4/4networking.png" />
							<?php else:?>
						...
						<div class="getBox">							
							...
							<ul class="cms-list userTop p-style">
								...
								<li>2. <?php echo translate_phrase("Buy tickets for a DateTix event on this page")?></li>
						...
						<div class="getBox">
							<?php if($total_rsvped >= 20) :?>
								...
								<div class="affiliations-logo">
									...
									<div class="aff-logo-event-details"><img style="max-width: 100px; max-height: 100px;" src="<?php echo base_url().'school_logos/'.$value['logo_url']?>" title="<?php echo $value['school_name'];?>" alt="<?php echo $value['school_name'];?>"></div>
									<?php endforeach;?>
								</div>
						                <?php endif;?>
								...
								<div class="paymentArea">
									...
									<form id="payment_form"
										...
										<?php if($event_info['max_prepaid_tickets'] > SMALL_EVENT_USER_LIMIT):?>
											...
											<?php else:?>
												<?php if($ad_id != 4):?>
												<div class="style01 comn-top-mar"><span class="DarkGreen-color"><b><?php echo translate_phrase("A 45% member discount has been applied to your ticket price because you are a DateTix member")?>!</b></span></div>																				
												<?php else:?>
