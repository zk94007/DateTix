	...
	public function processRequestsAction() {
		...
		if (!empty($b2bID) && array_key_exists($action, $possibleActions) !== FALSE) {//data is what we expected
			...
			if ($updateStastus) {
                           ...
                           /*//Added By Jigar Oza
                                //insert into matchmaker_transaction table
                                $this -> general -> set_table('matchmaker_transaction');
                                $dataToInsert=array('date_ticket_price_id'=>'',
                                                'website_id'=>'',
                                                'age'=>'',
                                                'gender_id'=>'',
                                                'num_date_tix'=>'',
                                                'price'=>'');
                                $this->general->save($dataToInsert);
                            */                                                                
