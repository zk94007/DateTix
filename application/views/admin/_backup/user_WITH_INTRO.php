...
class User extends MY_Controller {
	...
	public function test($lang_id = '')
	{
		...
		echo "<pre>";
		echo "Dropdown Results:";
		$data['country'] = $this -> model_user -> get_country_city($lang_id);
		echo $this->db->last_query();
		print_r($data['country'] );
		
		
		$this -> general_model -> set_table('country');
		$condition['display_language_id'] = $lang_id ;
		$all_countries = $this -> general_model -> get('',$condition);		
		echo "all countries<br/>";
		echo $this->db->last_query();
