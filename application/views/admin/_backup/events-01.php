...
//							else
	...
	private function _get_ticket_package($event_data) {
		...
		//$total_save_amount = $event_data['partner_discount'];
		//$package_price -= $total_save_amount;
		$total_save_amount = $event_data['price_online'] - $event_data['price_online_discounted'];		
		$save_per = round(100 - (($event_data['price_online_discounted'] - $event_data['partner_discount']) * 100) / ($event_data['price_online'] - $event_data['partner_discount']));
		//$save_per = round(100 - ($event_data['partner_discount'] * 100) / $package_price);
