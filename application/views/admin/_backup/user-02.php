...
class User extends CI_Controller {
	...
	*/
	...
	public function user_info($view_user_id, $login_user_id = '', $pass = '') {
		...
		if (!$user_intros && $user_id != $cur_user_id) {
			...
			if ($tmp_usr_data) {
				...
				//Mutual Friends
				if ($tmp_usr_data['facebook_id']) {
					//parse_str( $_SERVER['QUERY_STRING'], $_REQUEST );
					$this -> load -> library('Facebook');
					try {
						$fb_id = $this -> facebook -> getUser();
						if ($fb_id)
							$user_datas['mutual_friends'] = $this -> facebook -> api('/me/mutualfriends/' . $tmp_usr_data['facebook_id']);
					} catch (Exception $e) {
	...
	public function edit_school() {
		...
		$result = $this -> model_user -> get_school_details($user_school_id, $language_id);
	...
	public function get_school_id() {
		...
		$school_id = $this -> model_user -> get_school_id($school_name, $language_id);
	...
	public function show_school_logo() {
		$language_id = $this -> session -> userdata('sess_language_id');
		$school_name = $this -> input -> post('school_name');
		$result = $this -> model_user -> get_school_logo($school_name, $language_id);
		echo $result;
	}
	...
	public function show_school_domain() {
		$language_id = $this -> session -> userdata('sess_language_id');
		$school_name = $this -> input -> post('school_name');
		$result = $this -> model_user -> get_school_email_domain($school_name, $language_id);
	...
	public function verify_email() {
		...
		if ($value == 'school') {
			$user_school = $this -> model_user -> get_school_details($id, $language_id);
			$email_verf_code = $user_school['0']['verification_code'];
		} else {
			$user_company = $this -> model_user -> get_company_details($id, $language_id);
	...
	public function show_company_industry() {
		...
		$result = $this -> model_user -> get_company_industry($company_name, $language_id);
		echo $result;
	}
	...
	public function show_company_logo() {
		$language_id = $this -> session -> userdata('sess_language_id');
		$company_name = $this -> input -> post('company_name');
		$result = $this -> model_user -> get_company_logo($company_name, $language_id);
		echo $result;
	}
	...
	public function show_company_domain() {
		$language_id = $this -> session -> userdata('sess_language_id');
		$company_name = $this -> input -> post('company_name');
		$result = $this -> model_user -> get_company_email_domain($company_name, $language_id);
	...
	public function edit_company() {
		$language_id = $this -> session -> userdata('sess_language_id');
		$user_company_id = $this -> input -> post('user_company_id');
		$result = $this -> model_user -> get_company_details($user_company_id, $language_id);
		print_r(json_encode($result));
	}
