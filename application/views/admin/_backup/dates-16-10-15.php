	...
	private function _get_date_packages()
	{
		return array(
						'1'=>array(
							...
							'description'=>'With our Bronze date package, we will invite up to 10 of your top matches to apply to your date. <b>20 of your top matches</b>',
							'tag_line'=>'Bronze date package will cost you 50 date tickets',								
							'use_tickets'=>'50',
						),
						'2'=>array(
							'name'=> 'Silver',
							'image'=>base_url('assets/images/award-silver.png'),
							'description'=>'With our Silver date package, we will invite up to 50 of your top matches to apply to your date. <b>50 of your top matches</b>',
							'tag_line'=>'Silver date package will cost you 200 date tickets',
							'use_tickets'=>'200',
						),
						'3'=>array(
							'name'=> 'Gold',
							'image'=>base_url('assets/images/award-gold.png'),
							'description'=>'With our Gold date package, we will invite up to 100 of your top matches to apply to your date. <b>100 of your top matches</b>',
							'tag_line'=>'Gold date package will cost you 500 date tickets',
							'use_tickets'=>'500',								
						),
						'4'=>array(
							'name'=>'Platinum',
							'image'=>base_url('assets/images/award-platinum.png'),
							'description'=>'With our Platinum date package, we will invite up to 200 of your top matches to apply to your date. <b>200 of your top matches</b>',
							'tag_line'=>'Platinum date package will cost you 1,200 date tickets',								
							'use_tickets'=>'1200',
						),
					);
	}
