...
echo $query;
	...
	public function index($intro_type = 'active') {
        ...
        if($intro_type == 'handpicked'){
           $query = $common_sql . ' AND (handpicked_time IS NOT NULL OR handpicked_time != "0000-00-00 00:00:00") group by user_intro.user_intro_id
...
//echo '<pre>';print_r($data);die();
	...
	public function load_intro($intro_type = 'active') {
        ...
        if ($intro_type == 'handpicked') {
            $query = $common_sql . ' AND (handpicked_time IS NOT NULL OR handpicked_time != "0000-00-00 00:00:00")';
        }
        else if ($intro_type == 'expired') {
