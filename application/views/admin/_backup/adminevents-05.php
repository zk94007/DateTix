...
class Adminevents extends CI_Controller {
	...
	public function index()
	{
		...
		//Get Event datas
		$fields = array('e.event_id, e.event_start_time, e.event_end_time, e.price_door, e.tickets_sold_at_door, e.cash_collected_at_door, e.price_online, e.price_online_discounted',
						...
						'(SELECT COUNT(DISTINCT user_ip) FROM log_event_ad WHERE event_id = e.event_id) as visitors',						
