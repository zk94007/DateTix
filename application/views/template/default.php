...
$(function() {
	window.fbAsyncInit = function() {
		  FB.init({appId      : '<?php echo $fb_app_id ?>', // App ID
...
function fb_login () {
    ...
    else
    {
	    ...
	    }, {scope: 'email,user_photos,user_activities,user_about_me,user_birthday,user_education_history,user_groups,user_hometown,user_interests,user_likes,user_location,user_relationships,user_relationship_details,user_website,user_work_history,friends_relationships,friends_relationship_details,friends_location'});
    ...
    function direct_to_signup () {
       ...
       $.get(base_url +'fb_login/facebook/', { 'invite_id': '<?php  echo isset($invite_id)?$invite_id:"" ?>' }, function(data) {
				...
				<div class="L-header-right">
					...
					<div class="L-sign-inFB">
						<a href="#" onclick="fb_login();return false;"
							class="facebook-image"><img
							src="<?php echo base_url()?>assets/images/sign-in-fb.jpg"
							alt="fb_login" /> </a>
					</div>
					<?php endif;?>
