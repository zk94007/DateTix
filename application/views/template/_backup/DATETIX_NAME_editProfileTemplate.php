...
<link href="<?php echo get_assets('css_url',base_url().'assets/css/stylesheet.css');?>" rel="stylesheet" type="text/css" />
				...
				<div class="Head-M-top">
					<div class="Head-leftside">
						<div class="L-logo-part">
							...
							<div class="Head-Logo">
								<a href="<?php echo base_url() . url_city_name() ;?>/edit-profile.html">
						...
						<div class="NEWHead-nav">
							<div class="Head-nav">
								<ul>
									...
									<li><span id="active_dates_notification"></span>
						...
						<div class="Move3-friend">
							<div class="Invite-Btn-area">
								...
								<div class="Upg-ac-btn" style="position: relative; bottom: 0px;">
									...
									<a href="<?php echo 'mailto:?subject=Hello&amp;body=Hey! Have you tried DateTix? Its a great way to meet new friends and potential dates. You can find out more details and sign up at http://www.datetix.hk/mnc';?>"><span class="Headrespon-but"><?php echo translate_phrase('Invite Friends');?>
									<?php else: ?>
									<a href="<?php echo 'mailto:?subject=Hello&amp;body=Hey! Have you tried DateTix? Its a great way to meet new friends and potential dates. You can find out more details and sign up at http://www.datetix.com';?>"><span class="Headrespon-but"><?php echo translate_phrase('Invite Friends');?>
