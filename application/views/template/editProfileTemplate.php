...
<link href="<?php echo base_url()?>assets/css/sidetogglemenu.css" rel="stylesheet" />
...
$(document).ready(function () {
  ...
  //**** [END] COMMON DROPDOWN ANIMATION WITH VALUE RETRIVAL ***//
   ...
   function getSelectedValue(id) {
	...
	<?php if($this->session->userdata('singup_reward')):?>
	var PopupHTML = '<div class="edu-main"><p>You have just been given 50 free date tickets for signing into your account today!</p></div><div class="column-100"><div class="Nex-mar mar-top2"><input type="button" onclick="$.fancybox.close();" class="btn btn-blue disable-butn right date-btn" value="Ok"></div></div>';

	setTimeout(function(){openFancybox(PopupHTML)},1000);
	<?php  $this->session->unset_userdata('singup_reward');
	endif;?>
...
<style>
	.content-part{min-height:500px;}
	.fancybox-inner .content-part{min-height:50px !important;}
</style>
</head>
<body>
<?php
...
?>
	<div id="rightPen" class="main">
				...
				<div class="Head-M-top">
					<div class="Head-leftside">
						<div class="L-logo-part">
							...
							<div class="Head-Logo">
								<a href="<?php echo base_url('dates/find_dates')?>">
					...
					<div class="Head-rightside">
						<div class="NEWHead-nav">
							<div class="Head-nav">
								<ul>
									...
									<li class="spc-non">
										<a class="<?php echo ($this->uri->segment('2') == 'my_dates')?'active':''?>" href="<?php echo base_url('dates/my_dates')?>"><?php echo translate_phrase('My Dates') ?></a>
										<!--<a class="<?php echo $this->uri->segment('2') == 'edit-profile.html'?'active':''?>" href="<?php echo base_url() . url_city_name() ?>/edit-profile.html"><?php echo translate_phrase('My Profile') ?></a>-->										
									</li>
									<li>
										<span id="active_intro_notification"></span>
											<a class="<?php echo $this->uri->segment('2') == 'my-intros.html'?'active':''?>" href="<?php echo base_url() . url_city_name() ?>/my-intros.html"><?php echo translate_phrase('My Intros ') ?></a>
						...
						<div class="Move3-friend">
							<div class="Invite-Btn-area">
								...
								<?php if($user_friends_with_datetix):?>
									<a href="<?php echo base_url() . url_city_name() ?>/invite-friends.html"><?php echo count($user_friends_with_datetix). translate_phrase(' Facebook friends');?></a>
								...
								<div class="Upg-ac-btn" style="position: relative; bottom: 0px;">
									<!--<a href="<?php echo base_url() . url_city_name() ?>/events.html"><span class="Headrespon-but"><?php echo translate_phrase('RSVP for Events');?>-->
						...
						<div class="Head-Top-Button">
							<div class="Top-Button022">
								...
								<a href="<?php echo base_url() . url_city_name() ?>/get-more-tickets.html"><?php 
								echo translate_phrase('You have ').'<span class="user_num_date_tix">'.number_format($user_data['num_date_tix']).'</span>'.translate_phrase(' date '); 
								
								echo $user_data['num_date_tix'] == 1?translate_phrase(' ticket left.'):translate_phrase(' tickets left.');
								?></a>
								</div>
								<a href="<?php echo base_url() . url_city_name() ?>/get-more-tickets.html"><div class="Headrespon-but"><?php echo translate_phrase('Get More Date Tickets') ?></div></a>
							</div>
		...
		<div class="sidebar desktop-view">
			<ul>
				<li><a class="small round <?php echo $this->uri->segment('2') == 'new_date_step1'?'active':''?>" href="<?php echo base_url('dates/new_date_step1');?>"><span class="dt-app-icon icon-big-plus"></span> <span class="icon-text">New Date</span></a></li>
				<li><a class="small round <?php echo $this->uri->segment('2') == 'find_dates'?'active':''?>" href="<?php echo base_url('dates/find_dates');?>"><span class="dt-app-icon icon-dates"></span> <span class="icon-text">Find Dates</span></a></li>
				<li><a class="small round <?php echo $this->uri->segment('1') == 'people'?'active':''?>" href="<?php echo base_url('people');?>"><span class="dt-app-icon icon-user"></span> <span class="icon-text">Find People</span></a></li>				
				<li><a class="small round <?php echo $this->uri->segment('2') == 'user_chats'?'active':''?>" href="<?php echo base_url('dates/user_chats');?>"><span class="dt-app-icon icon-chat44"></span> <span class="icon-text">Chats</span></a></li>
				<li><a class="small round <?php echo $this->uri->segment('2') == 'setting.html'?'active':''?>" href="<?php echo base_url().url_city_name().'/setting.html';?>"><span class="dt-app-icon icon-settings44"></span> <span class="icon-text">Settings</span></a></li>
			</ul>
		</div>
		<!-- Desktop Version -->
		...
		<div class="footer stick-bottom">
			<div class="stick-bar">
				<a class="small round <?php echo $this->uri->segment('2') == 'find_dates'?'active':''?>" href="<?php echo base_url('dates/find_dates');?>"><span class="dt-icon icon-dates"></span> <span class="text">Dates</span></a>
				<a class="small round <?php echo $this->uri->segment('1') == 'people'?'active':''?>" href="<?php echo base_url('people');?>"><span class="dt-icon icon-user"></span> <span class="text">People</span></a>
				<a class="big round <?php echo $this->uri->segment('2') == 'new_date_step1'?'active':''?>" href="<?php echo base_url('dates/new_date_step1');?>"><span class="dt-footer-icon icon-big-plus"></span> <span class="text">New Date</span></a>
				<a class="small round <?php echo $this->uri->segment('2') == 'user_chats'?'active':''?>" href="<?php echo base_url('dates/user_chats');?>"><span class="dt-icon icon-chat44"></span> <span class="text">Chats</span></a>
				<a class="small round <?php echo $this->uri->segment('2') == 'setting.html'?'active':''?>" href="<?php echo base_url().url_city_name().'/setting.html';?>"><span class="dt-icon icon-settings44"></span> <span class="text">Settings</span></a>
			</div>
		</div>	
				...
				<div class="footer-right">
					...
					<div class="footer-link">
						<ul id="footer-nav">
							...
							<li class="bg-none"><a href="<?php echo base_url().url_city_name() ?>/privacy.html" title="Privacy Policy"><?php echo translate_phrase('Privacy') ?></a></li>
							<!--<li><a href="<?php echo base_url().url_city_name() ?>/help.html" title="Help"><?php echo translate_phrase('Help') ?></a></li>-->
	...
	<div class="sidetogglemenu">
		<div class="msg-main">
			...
			<div class="Top-Button022">
				<div class="Top-Button-Tittle">
				<a href="<?php echo base_url() . url_city_name() ?>/get-more-tickets.html"><?php echo translate_phrase('You have ').number_format($user_data['num_date_tix']).translate_phrase(' date '); echo $user_data['num_date_tix'] == 1?translate_phrase(' ticket left.'):translate_phrase(' tickets left.'); ?></a>
				</div>
				<a href="<?php echo base_url() . url_city_name() ?>/get-more-tickets.html"><div class="Headrespon-but"><?php echo translate_phrase('Get More Date Tickets') ?></div></a>
			</div>
		</div>
