...
class Date_api_model extends  CI_Model {
    ...
    public function find_date_ids($user_id, $sort_by_distance = 0, $limit = 0, $offset = 0) {
        ...
        $CI -> load -> model('api/v1/user_preferred_date_type_api_model');
        $CI -> load -> model('api/v1/user_want_body_type_api_model');
        $CI -> load -> model('api/v1/user_want_child_plan_api_model');
        $CI -> load -> model('api/v1/user_want_child_status_api_model');
        $CI -> load -> model('api/v1/user_want_company_api_model');
        $CI -> load -> model('api/v1/user_want_descriptive_word_api_model');
        $CI -> load -> model('api/v1/user_want_drinking_status_api_model');
        $CI -> load -> model('api/v1/user_want_education_level_api_model');
        $CI -> load -> model('api/v1/user_want_ethnicity_api_model');
        $CI -> load -> model('api/v1/user_want_exercise_frequency_api_model');
        $CI -> load -> model('api/v1/user_want_gender_api_model');
        $CI -> load -> model('api/v1/user_want_relationship_status_api_model');
        $CI -> load -> model('api/v1/user_want_relationship_type_api_model');
        $CI -> load -> model('api/v1/user_want_religious_belief_api_model');
        $CI -> load -> model('api/v1/user_want_residence_type_api_model');
        $CI -> load -> model('api/v1/user_want_school_api_model');
        $CI -> load -> model('api/v1/user_want_smoking_status_api_model');
        $CI -> load -> model('api/v1/date_decision_api_model');
    ...
    public function get_my_dates($user_id, $limit = 0, $offset = 0, $is_upcoming = TRUE, $my_hosts_only = TRUE) {
        ...
        if ($my_hosts_only == TRUE) {
            $this -> db -> where('date.requested_user_id', $user_id);
        } else {
            $this -> db -> join('date_applicant', 'date_applicant.date_id = date.date_id', 'left');
            $this -> db -> where("((date_applicant.applicant_user_id = {$user_id} AND date_applicant.status = 1) OR date.requested_user_id = {$user_id})", NULL, FALSE);
        }
        ...
        if ($result -> num_rows() > 0) {
            ...
            $CI -> load -> model('api/v1/date_decision_api_model');
            $CI -> load -> model('api/v1/date_payer_api_model');
            $CI -> load -> model('api/v1/date_type_api_model');
            $CI -> load -> model('api/v1/date_applicant_api_model');
            $CI -> load -> model('api/v1/merchant_api_model');
            $CI -> load -> model('api/v1/relationship_type_api_model');
            $CI -> load -> model('api/v1/user_api_model');
            $CI -> load -> model('api/v1/user_photo_api_model');
            ...
            foreach ($result -> result_array() as $date) {
                ...
                $merchant = $CI -> merchant_api_model -> get_merchant($date['merchant_id']);
