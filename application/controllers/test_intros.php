...
class Test_intros extends CI_Controller {
	...
	public function index() {
		...
		$query = $common_sql . 'AND DATE(intro_expiry_time) < DATE(CURDATE())
                ORDER BY `intro_available_time` DESC ' . $limit;
		...
		echo $query;
		echo "<pre>";print_r($active_intro);exit;
		//SQL_DATE
